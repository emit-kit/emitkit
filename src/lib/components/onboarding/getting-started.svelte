		...
		<Accordion.Root type="single" value="step-2" class="w-full">
			...
			<Accordion.Item value="step-1">
				...
				<Accordion.Content class="space-y-4">
					...
					<p class="text-sm text-muted-foreground">
						<strong>Key Point:</strong> API keys are scoped to both your organization AND a specific
						site, giving you fine-grained control over which apps can send events where.
					</p>
				</Accordion.Content>
			</Accordion.Item>
